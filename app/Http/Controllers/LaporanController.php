...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        // 2. Laporan Biaya Ujrah (from perpanjangan + biaya_penitipan on new transactions)
        ...
        // 4. Laporan Barang Jaminan - ENHANCED: show ALL active items, not just period
        $laporanBarang = DetailTransaksi::whereHas('transaksiRahn', function ($q) {
        ...
        // 5. Laporan Jatuh Tempo - with search/filter
        ...
        // Recent transactions for period table
        ...
        return view('laporan.index', compact(
            'period', 'periodLabel', 'search',
            'laporanAdmin', 'laporanUjrah', 'laporanPinjaman',
