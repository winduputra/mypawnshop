<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
            <div class="flex-1 w-full sm:max-w-sm relative">
                <input type="text" id="search-kasir" placeholder="Cari nama, email, atau cabang..."
                    class="w-full bg-white border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 text-slate-800 text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500/50">
            ...
            <a href="{{ route('kasir.create') }}" class="bg-[#cf9e50] hover:bg-[#b48842] text-white font-semibold py-2 px-4 rounded-xl shadow-sm transition-all flex-shrink-0 flex items-center space-x-2">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden" id="kasir-table-wrapper">
