<x-app-layout>
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <a href="{{ route('nasabah.create') }}" class="bg-[#cf9e50] hover:bg-[#b48842] text-white font-semibold py-2 px-4 rounded-xl shadow-sm transition-all whitespace-nowrap">
            Tambah Nasabah
        </a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody id="nasabah-table-body" class="divide-y divide-slate-200 text-sm">
