...
<div class="space-y-6">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-2xl font-semibold text-white">Edit Cabang</h1>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-200">{{ old('alamat', $cabang->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                    @enderror
                </div>
